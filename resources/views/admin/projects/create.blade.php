            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text"  value="{{old('framework')}}" placeholder="es. 'Vue, React, ...'" name="framework" class="form-control @error('framework') is-invalid @enderror" id="framework" aria-describedby="frameworkHelp" required>
                        @error('framework')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
